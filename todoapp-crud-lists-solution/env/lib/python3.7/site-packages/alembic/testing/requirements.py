...
class SuiteRequirements(Requirements):
    ...
    def sqlalchemy_issue_3740(self):
        ...
        return exclusions.skip_if(
            lambda config: not util.sqla_120, "SQLAlchemy 1.2 or greater required",
        )

    @property
    def sqlalchemy_12(self):
        return exclusions.skip_if(
            lambda config: not util.sqla_1216, "SQLAlchemy 1.2.16 or greater required",
        )

    @property
    def sqlalchemy_13(self):
        return exclusions.skip_if(
            lambda config: not util.sqla_13, "SQLAlchemy 1.3 or greater required",
        )
    ...
    def comments(self):
        return exclusions.only_if(
            lambda config: sqla_compat._dialect_supports_comments(config.db.dialect)
        )
